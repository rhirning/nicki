...
public class MailTemplateViewer extends CustomComponent {
	 ...
	 * visual editor.
	 */
	public MailTemplateViewer(NickiContext ctx, Class<?> classDefinition, String path, String localeName, String messageKeyBase) {
		this.context = ctx;
		this.hasTestData = false;
		this.allowDelete = true;
		this.messageKeyBase = messageKeyBase;
		if (context.isExist(path)) {
			DynamicObject localeObject = context.loadObject(path);
			...
			createButton.addListener(new CreateLocaleListener(classDefinition, path));
	...
	public class CreateLocaleListener implements Button.ClickListener {
		...
		public CreateLocaleListener(Class<?> classDefinition, String path) {
			super();
		...
		public void buttonClick(ClickEvent event) {
			try {
				...
				DynamicObject localeTemplate = context.createDynamicObject(classDefinition, parentPath, namingValue);
	...
	protected void delete() {
		if (this.template != null) {
			Class<?> classDefinition = template.getClass();
