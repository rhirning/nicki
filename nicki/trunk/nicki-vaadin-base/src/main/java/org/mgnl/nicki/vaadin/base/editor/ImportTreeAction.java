...
import org.mgnl.nicki.ldap.xml.XMLImporter;
...
public class ImportTreeAction extends BaseTreeAction implements  Upload.SucceededListener,
	...
	public void execute(Window parentWindow, DynamicObject dynamicObject) {
		...
		importComponent.addListener((Upload.SucceededListener) this);
		importComponent.addListener((Upload.FailedListener) this);
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		importComponent.setImmediate(true);
	...
	public void uploadFailed(FailedEvent event) {
		...
		getWindow().showNotification("Import failed", "Importing "
                + event.getFilename() + " of type '"
                + event.getMIMEType() + "' failed.", Notification.TYPE_ERROR_MESSAGE);
	}
	...
	public void uploadSucceeded(SucceededEvent event) {
		try {
			...
			getWindow().showNotification("Import successful", Notification.TYPE_HUMANIZED_MESSAGE);
		} catch (Exception e) {
			getWindow().showNotification("Import failed", "Importing "
	                + event.getFilename() + " of type '"
	                + event.getMIMEType() + "' failed.", Notification.TYPE_ERROR_MESSAGE);
