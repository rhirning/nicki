...
public class ApplicationLoginDialog extends CustomComponent implements LoginDialog, CallbackHandler {
	@AutoGenerated
	...
	private static final Logger LOG = LoggerFactory.getLogger(ApplicationLoginDialog.class);
	...
	public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
		ApplicationLoginDialog loginDialog = new ApplicationLoginDialog();
		Window window = new Window("Login", loginDialog);
