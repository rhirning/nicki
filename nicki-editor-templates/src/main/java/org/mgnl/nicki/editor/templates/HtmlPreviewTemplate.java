...
public class HtmlPreviewTemplate extends BaseTreeAction {
	 ...
	 * @param localeString 
	 */
	public HtmlPreviewTemplate(NickiContext context, Class<? extends DynamicObject> classDefinition,
	...
	public HtmlPreviewTemplate(NickiContext context, String i18nBase) {
		super(null, null);
		this.context = context;
		this.i18nBase = i18nBase;
		buildMainLayout();
