 ...
 */
package org.mgnl.nicki.db.test.example;
...
public class PoolingDataSourceExample {
	...
	public static void main(String[] args) {
		new PoolingDataSourceExample().runExample(args);
	}
	...
	private void runExample(String[] args) {
		...
		DataSource dataSource = setupDataSource(args[0], args[2], args[3]);
		System.out.println("Done.");

		for (int i = 0; i < 10; i++) {
			System.out.println("Run: " + i);
			executeQuery(dataSource, args[1]);
		}
	 ...
	 *
	 */
	private void executeQuery(DataSource dataSource, String sqlQuery) {
		//
		...
		try {
			printDriverStats(dataSource);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void printDriverStats(DataSource dataSource) throws Exception {

		System.out.println("MinIdle: " + connectionPool.getMinIdle());
		System.out.println("MaxIdle: " + connectionPool.getMaxIdle());
		System.out.println("NumActive: " + connectionPool.getNumActive());
		System.out.println("NumIdle: " + connectionPool.getNumIdle());
	}

	public PoolingDataSource<PoolableConnection> setupDataSource(String connectURI, String user, String password) {
		//
...
//		connectionPool.setMinIdle(GenericObjectPoolConfig.DEFAULT_MIN_IDLE);
//		connectionPool.setMaxIdle(GenericObjectPoolConfig.DEFAULT_MAX_IDLE);
