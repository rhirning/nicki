...
public class EnterSpecifierDialog extends EnterNameDialog implements NewItemHandler {
	...
	@AutoGenerated
	private AbstractField specifier;
	...
	public EnterSpecifierDialog(String messageBase) {
		super(messageBase);
	...
	public void addTextField() {
		// specifier
		specifier = new TextField();
		specifier.setWidth("200px");
		specifier.setHeight("-1px");
		specifier.setImmediate(true);
		mainLayout.addComponent(specifier, "top:60.0px;left:20.0px;");
	}
