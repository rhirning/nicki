...
public class InfoView extends CustomComponent implements ConfigurableView {
	...
	public void init() {
		...
		if (!isInit) {
			...
			if (isEditor()) {
				editInfoButton.addClickListener(new Button.ClickListener() {
					private static final long serialVersionUID = 6594026135178229013L;
				...
				saveInfoButton.addClickListener(new Button.ClickListener() {
					private static final long serialVersionUID = 8294989051378933376L;
